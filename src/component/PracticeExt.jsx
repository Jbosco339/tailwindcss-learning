...
function PracticeExt() {
  return (
    <div>
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 dark:text-white">
        <nav className="flex justify-between items-center px-6 py-4 bg-white dark:bg-gray-800 shadow fixed w-screen">
          <h1 className="font-bold text-lg cursor-pointer hover:bg-cyan-300 hover:text-black px-2">
            TailwindPractice
          </h1>

          <div className="hidden md:flex gap-6">
            <ul className="flex ">
              <li className="mr-2 cursor-pointer hover:bg-cyan-300 hover:text-black px-2">
                Home
              </li>
              <li className="mr-2 cursor-pointer hover:bg-cyan-300 hover:text-black px-2">
                About us
        ...
        <section className="p-8">
          ...
          <main className="bg-gray-200 dark:bg-gray-800 p-6 rounded md:col-span-3">
            <p>
              This is the main dashboard content area. Resize the screen to see
              how the sidebar moves above the content on mobile screens.
            </p>
          </main>
        </section>
      </div>
